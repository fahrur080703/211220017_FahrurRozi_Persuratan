    ...
    <div class="grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="/update-sm/{{ $data->id }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_surat" class="form-control" id="no_surat" placeholder="Nomor Surat" value="{{ $data->no_surat }}">
                        @error('no_surat')
                        <p class="text-danger pt-1"><small>{{ $message }}</small></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="asal_surat" class="form-control" id="asal_surat" placeholder="Asal Surat" value="{{ $data->asal_surat }}">
                        @error('asal_surat')
                        <p class="text-danger pt-1"><small>{{ $message }}</small></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="perihal" class="form-control" id="perihal" placeholder="Perihal" value="{{ $data->perihal }}">
                        @error('perihal')
                        <p class="text-danger pt-1"><small>{{ $message }}</small></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="disp1" class="form-control" id="disp1" placeholder="Disposisi 1" value="{{ $data->disp1 }}">
                        @error('disp1')
                        <p class="text-danger pt-1"><small>{{ $message }}</small></p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="disp2" class="form-control" id="disp2" placeholder="Disposisi 2" value="{{ $data->disp2 }}">
                        @error('disp2')
                        <p class="text-danger pt-1"><small>{{ $message }}</small></p>
                        @enderror
                    </div>
